//
//  CarDescriptionArabicViewController.m
//  BoxBazar
//
...
#import "ChatingArabicViewController.h"
#import "DetailArabicViewController.h"

@interface CarDescriptionArabicViewController ()<ApiRequestdelegate,LCBannerViewDelegate>
{
...
@implementation CarDescriptionArabicViewController
...
//            [scrollView addSubview:buttonclick];
            ...
            [scrollView addSubview:({
                ...
                bannerView.didClickedImageIndexBlock = ^(LCBannerView *bannerView, NSInteger index) {
                    ...
                    DetailArabicViewController *detail=[self.storyboard instantiateViewControllerWithIdentifier:@"DetailArabicViewController"];
                    detail.strUrls=URLs;
    ...
    UIImageView *imagebig=[[UIImageView alloc] initWithFrame:CGRectMake(10, 256, 36, 36)];
    ...
    titlelab=[[UILabel alloc]initWithFrame:CGRectMake(10, 5, self.view.frame.size.width-20, 40)];
...
//                            14,
//                            urlString];
    [desview loadHTMLString:[NSString stringWithFormat:@"<div style='text-align:right'>%@<div>",urlString] baseURL:nil];
  //  [desview loadHTMLString:htmlString baseURL:nil];
    ...
    Adlab.textAlignment=NSTextAlignmentRight;
    ...
    UIView *detailview=[[UIView alloc] initWithFrame:CGRectMake(0, Adlab.frame.size.height+Adlab.frame.origin.y, self.view.frame.size.width, keyCount*42-5)];
    x=0;
    for (int i=0; i<dataarray.count; i++)
    {
        UILabel *labname=[[UILabel alloc] initWithFrame:CGRectMake(self.view.frame.size.width-150, x+5, 140, 35)];
        ...
        UILabel *labvalue=[[UILabel alloc] initWithFrame:CGRectMake(10, x+6, self.view.frame.size.width-160, 35)];
    ...
    locationlab1.textAlignment=NSTextAlignmentRight;
    ...
    UILabel *address=[[UILabel alloc]initWithFrame:CGRectMake(10, locationlab1.frame.size.height+locationlab1.frame.origin.y+5, self.view.frame.size.width-20, 35)];
    ...
    UILabel *addressname=[[UILabel alloc]initWithFrame:CGRectMake(10,locationlab1.frame.size.height+locationlab1.frame.origin.y+5, self.view.frame.size.width-120, 35)];
    ...
    addressname.textAlignment=NSTextAlignmentRight;
    ...
    sellarDetaillab1.textAlignment=NSTextAlignmentRight;
    ...
    UIImageView *image=[[UIImageView alloc] initWithFrame:CGRectMake(self.view.frame.size.width-90, detailsview.frame.size.height/2-40, 80, 80)];
    [image sd_setImageWithURL:[NSURL URLWithString:[[_strDataArray valueForKey:@"user"] valueForKey:@"pic"]]
             placeholderImage:[UIImage imageNamed:@"profilepic.png"]];
    ...
    UILabel *labname=[[UILabel alloc]initWithFrame:CGRectMake(10, detailsview.frame.size.height/2-47, detailsview.frame.size.width-110, 30)];
    ...
    UILabel *labemail=[[UILabel alloc]initWithFrame:CGRectMake(10, detailsview.frame.size.height/2-15, detailsview.frame.size.width-110, 30)];
    labemail.text=[[_strDataArray valueForKey:@"user"] valueForKey:@"email"];
    labemail.font=[UIFont systemFontOfSize:15];
    labemail.textAlignment=NSTextAlignmentRight;
    [detailsview addSubview:labemail];
    
    UILabel *labContact=[[UILabel alloc]initWithFrame:CGRectMake(10, detailsview.frame.size.height/2+17, detailsview.frame.size.width-110, 30)];
    labContact.text=[[_strDataArray valueForKey:@"user"] valueForKey:@"contact"];
    labContact.font=[UIFont systemFontOfSize:15];
    labContact.textAlignment=NSTextAlignmentRight;
...
-(IBAction)ChatButtClicked:(id)sender
{
    ...
    if(object != nil)
    {
        ...
        NSString *strurl=[NSString stringWithFormat:@"%@%@/%@/%@/%@",BaseUrl,strtoken,setConversation,arabic,strCityId];
...
-(void)responsewithToken2:(NSMutableDictionary *)responseToken
{
    ...
    {
        ChatingArabicViewController *chat=[self.storyboard instantiateViewControllerWithIdentifier:@"ChatingArabicViewController"];
...
-(IBAction)SharebuttClicked:(id)sender
{
    ...
    UILabel *lab=[[UILabel alloc]initWithFrame:CGRectMake(footerview.frame.size.width-100, 0, 90, 40)];
    lab.text=@"Options";
    ...
    UIButton *butt11=[[UIButton alloc]initWithFrame:CGRectMake(10, 0, footerview.frame.size.width-50, 40)];
    ...
    buttla.contentHorizontalAlignment = UIControlContentHorizontalAlignmentRight;
    ...
    imaged=[[UIImageView alloc] initWithFrame:CGRectMake(10, labeunder.frame.origin.y+12, 25, 25)];
    if (fav==NO)
    {
    ...
    butt2.contentHorizontalAlignment = UIControlContentHorizontalAlignmentRight;
