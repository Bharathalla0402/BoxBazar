...
@interface PostingViewController ()<ApiRequestdelegate,UITextFieldDelegate,UITextViewDelegate,UICollectionViewDelegate,UICollectionViewDataSource,UITableViewDelegate,UITableViewDataSource>
{
...
//    publicIP = [NSString stringWithContentsOfURL:[NSURL URLWithString:@"https://icanhazip.com/"] encoding:NSUTF8StringEncoding error:nil];
...
-(void)localip
{
    ...
    [request setURL:[NSURL URLWithString:@"http://think360.in/boxbazaar/api/index.php/f2781d/ipAddress/en/1"]];
...
-(void)moreaction
{
    ...
    CategeoryDetaillab.textAlignment=NSTextAlignmentLeft;
    ...
    Categorytypelab.textAlignment=NSTextAlignmentLeft;
    ...
    Categorytypelabtext.textAlignment=NSTextAlignmentLeft;
    ...
    UIImageView *image1=[[UIImageView alloc]initWithFrame:CGRectMake(view1.frame.size.width-26, 24,16, 16)];
    ...
    Categorysubtypelab.textAlignment=NSTextAlignmentLeft;
    ...
    CategorySubtypelabtext.textAlignment=NSTextAlignmentLeft;
    ...
    UIImageView *image2=[[UIImageView alloc]initWithFrame:CGRectMake(view1.frame.size.width-26, Categorytypeunderlinelab.frame.origin.y+Categorytypeunderlinelab.frame.size.height+24,16, 16)];
...
{
    if ([_strCategeory isEqualToString:@"Motors"])
    {
...
-(void)subcategoryOptionlist
{
    ...
    NSString *strtoken=[[NSUserDefaults standardUserDefaults]objectForKey:@"Token"];
    NSString *strCityId=[[NSUserDefaults standardUserDefaults]objectForKey:@"CityId"];
    NSString *strurl=[NSString stringWithFormat:@"%@%@/%@/%@/%@?module=%@&category=%@",BaseUrl,strtoken,CategoryOption,english,strCityId,_strcategeoryTypeurl_parameter,_strcategeoryTypeid];
    [requested emptyCategoryOptionRequest:nil withUrl:strurl];
    
//    [DejalBezelActivityView activityViewForView:self.view withLabel:@"please wait..."];
//    NSString *strtoken=[[NSUserDefaults standardUserDefaults]objectForKey:@"Token"];
//     NSString *strCityId=[[NSUserDefaults standardUserDefaults]objectForKey:@"CityId"];
//    NSString *strurl=[NSString stringWithFormat:@"%@%@/%@/%@/%@?module=%@",BaseUrl,strtoken,Option,english,strCityId,_strcategeoryTypeurl_parameter];
...
-(void)emptyresponseCategoryOption:(NSMutableDictionary *)responseDict
{
    ...
    else
    {
        ...
        NSString *strtoken=[[NSUserDefaults standardUserDefaults]objectForKey:@"Token"];
        NSString *strCityId=[[NSUserDefaults standardUserDefaults]objectForKey:@"CityId"];
        NSString *strurl=[NSString stringWithFormat:@"%@%@/%@/%@/%@?module=%@&optionId=%@",BaseUrl,strtoken,Option,english,strCityId,_strcategeoryTypeurl_parameter,strdata];
        [requested emptyOptionRequest:nil withUrl:strurl];
    }
}
...
-(void)subcategorylist
{
    ...
    txtSubCate.textAlignment=NSTextAlignmentLeft;
    [txtSubCate setFont:[UIFont systemFontOfSize:15]];
    txtSubCate.textColor=[UIColor blackColor];
    [view2 addSubview:txtSubCate];
    
    
    UIImageView *image2=[[UIImageView alloc]initWithFrame:CGRectMake(view2.frame.size.width-26, 27,16, 16)];
    image2.image=[UIImage imageNamed:@"right-arrow-2.png"];
...
-(void)responseSubCategory:(NSMutableDictionary *)responseDict
{
    ...
    txtsubCate2.textAlignment=NSTextAlignmentLeft;
    ...
    UIImageView *image2=[[UIImageView alloc]initWithFrame:CGRectMake(view3.frame.size.width-26, 27,16, 16)];
    image2.image=[UIImage imageNamed:@"right-arrow-2.png"];
...
-(void)responseSubCategory2:(NSMutableDictionary *)responseDict
{
    ...
    txtsubCate3.textAlignment=NSTextAlignmentLeft;
    [txtsubCate3 setFont:[UIFont systemFontOfSize:15]];
    txtsubCate3.textColor=[UIColor blackColor];
    [view4 addSubview:txtsubCate3];
    
    
    UIImageView *image2=[[UIImageView alloc]initWithFrame:CGRectMake(view4.frame.size.width-26, 27,16, 16)];
    image2.image=[UIImage imageNamed:@"right-arrow-2.png"];
...
-(void)responseSubCategory3:(NSMutableDictionary *)responseDict
{
    ...
    txtsubCate4.textAlignment=NSTextAlignmentLeft;
    [txtsubCate4 setFont:[UIFont systemFontOfSize:15]];
    txtsubCate4.textColor=[UIColor blackColor];
    [view5 addSubview:txtsubCate4];
    
    
    UIImageView *image2=[[UIImageView alloc]initWithFrame:CGRectMake(view5.frame.size.width-26, 27,16, 16)];
    image2.image=[UIImage imageNamed:@"right-arrow-2.png"];
...
-(void)responsewithDataMakeMotor:(NSMutableDictionary *)responseDict
{
    ...
    scrollMainView.contentSize = CGSizeMake(self.view.frame.size.width, 1112+(DataMotorOptions.count*50));
...
-(void)commonview2
{
    ...
    txtCarprice.textAlignment=NSTextAlignmentLeft;
    ...
    UIImageView *image4=[[UIImageView alloc]initWithFrame:CGRectMake(motorView.frame.size.width-31, txtadDesc.frame.size.height+txtadDesc.frame.origin.y+17,16, 16)];
    ...
    for (int i=0; i<DataMotorOptions.count; i++)
    {
        ...
        UIImageView *image2=[[UIImageView alloc]initWithFrame:CGRectMake(motorView.frame.size.width-31, 12,16, 16)];
        image2.image=[UIImage imageNamed:@"right-arrow-2.png"];
    ...
    UILabel *lab9=[[UILabel alloc]initWithFrame:CGRectMake(10, 10, 178, 70)];
    ...
    CoverPhotoImage=[[UIImageView alloc]initWithFrame:CGRectMake(lab9.frame.size.width+lab9.frame.origin.x, 10, 70, 70)];
...
-(void)commonview2Job
{
    ...
    txtmake.textAlignment=NSTextAlignmentLeft;
    [txtmake setFont:[UIFont systemFontOfSize:15]];
    txtmake.delegate=self;
    txtmake.textColor=[UIColor blackColor];
    [motorView addSubview:txtmake];
    
    UIImageView *image1=[[UIImageView alloc]initWithFrame:CGRectMake(motorView.frame.size.width-31, txtadDesc.frame.size.height+txtadDesc.frame.origin.y+17,16, 16)];
    image1.image=[UIImage imageNamed:@"right-arrow-2.png"];
    ...
    txtModel.textAlignment=NSTextAlignmentLeft;
    [txtModel setFont:[UIFont systemFontOfSize:15]];
    txtModel.textColor=[UIColor blackColor];
    [motorView addSubview:txtModel];
    
    UIImageView *image2=[[UIImageView alloc]initWithFrame:CGRectMake(motorView.frame.size.width-31, txtmake.frame.size.height+txtmake.frame.origin.y+17,16, 16)];
    image2.image=[UIImage imageNamed:@"right-arrow-2.png"];
...
-(void)motorview2
{
    ...
    txtyear.textAlignment=NSTextAlignmentLeft;
    ...
    UIImageView *image3=[[UIImageView alloc]initWithFrame:CGRectMake(motorView.frame.size.width-31, txtModel.frame.size.height+txtModel.frame.origin.y+17,16, 16)];
...
//    [motorView addSubview:brandnamebutt3];
    ...
    UIImageView *image4=[[UIImageView alloc]initWithFrame:CGRectMake(motorView.frame.size.width-31, txtyear.frame.size.height+txtyear.frame.origin.y+17,16, 16)];
    image4.image=[UIImage imageNamed:@"right-arrow-2.png"];
    [motorView addSubview:image4];
...
//    [motorView addSubview:brandnamebutt4];
    ...
    txtKilometer.textAlignment=NSTextAlignmentLeft;
    ...
    UIImageView *image5=[[UIImageView alloc]initWithFrame:CGRectMake(motorView.frame.size.width-31, txtCarprice.frame.size.height+txtCarprice.frame.origin.y+17,16, 16)];
...
-(IBAction)MakeClicked:(id)sender
{
    ...
    NSString *strtoken=[[NSUserDefaults standardUserDefaults]objectForKey:@"Token"];
    NSString *strCityId=[[NSUserDefaults standardUserDefaults]objectForKey:@"CityId"];
    NSString *strurl=[NSString stringWithFormat:@"%@%@/%@/%@/%@?module=%@",BaseUrl,strtoken,carSubModule,english,strCityId,_strcategeoryTypeid];
...
-(IBAction)ModelClicked:(id)sender
{
    ...
    else
    {
        ...
        NSString *strtoken=[[NSUserDefaults standardUserDefaults]objectForKey:@"Token"];
        NSString *strCityId=[[NSUserDefaults standardUserDefaults]objectForKey:@"CityId"];
        NSString *strurl=[NSString stringWithFormat:@"%@%@/%@/%@/%@?make=%@",BaseUrl,strtoken,carModel,english,strCityId,strSubModule];
...
-(IBAction)MotorPostButtClicked:(id)sender
{
    ...
    else
    {
     ...
     //   [carpostvalue setObject:_strCategoryIdForPost forKey:@"category_id"];
        ...
        NSString *strtoken=[[NSUserDefaults standardUserDefaults]objectForKey:@"Token"];
        NSString *strCityId=[[NSUserDefaults standardUserDefaults]objectForKey:@"CityId"];
        NSString *strurl=[NSString stringWithFormat:@"%@%@/%@/%@/%@",BaseUrl,strtoken,CarAddPost,english,strCityId];
...
//        NSString *encodeDescription = [txtadDesc.text stringByAddingPercentEscapesUsingEncoding:NSUTF8StringEncoding];
        ...
        NSString *strtoken=[[NSUserDefaults standardUserDefaults]objectForKey:@"Token"];
        NSString *strCityId=[[NSUserDefaults standardUserDefaults]objectForKey:@"CityId"];
        NSString *strurl=[NSString stringWithFormat:@"%@%@/%@/%@/%@",BaseUrl,strtoken,AddPost,english,strCityId];
        [requested PostAddRequest:post withUrl:strurl];
    }
}
...
-(void)commonView3
{
    ...
    txtlocality.textAlignment=NSTextAlignmentLeft;
    [txtlocality setFont:[UIFont systemFontOfSize:15]];
    txtlocality.delegate=self;
    txtlocality.textColor=[UIColor blackColor];
    [ContactView addSubview:txtlocality];
    
    UIImageView *image1=[[UIImageView alloc]initWithFrame:CGRectMake(motorView.frame.size.width-31, 17,16, 16)];
    image1.image=[UIImage imageNamed:@"right-arrow-2.png"];
...
//    
//    UIImageView *image2=[[UIImageView alloc]initWithFrame:CGRectMake(motorView.frame.size.width-31, txtlocality.frame.size.height+txtlocality.frame.origin.y+17,16, 16)];
//    image2.image=[UIImage imageNamed:@"right-arrow-2.png"];
...
//    
//    UIImageView *image3=[[UIImageView alloc]initWithFrame:CGRectMake(motorView.frame.size.width-31, txtName.frame.size.height+txtName.frame.origin.y+17,16, 16)];
//    image3.image=[UIImage imageNamed:@"right-arrow-2.png"];
...
//    
//    UIImageView *image4=[[UIImageView alloc]initWithFrame:CGRectMake(motorView.frame.size.width-31, txtemail.frame.size.height+txtemail.frame.origin.y+17,16, 16)];
//    image4.image=[UIImage imageNamed:@"right-arrow-2.png"];
...
{
    PickTextViewController *pc=[self.storyboard instantiateViewControllerWithIdentifier:@"PickTextViewController"];
...
-(IBAction)localityClicked:(id)sender
{
    ...
    NSString *strtoken=[[NSUserDefaults standardUserDefaults]objectForKey:@"Token"];
    NSString *strCityId=[[NSUserDefaults standardUserDefaults]objectForKey:@"CityId"];
    NSString *strurl=[NSString stringWithFormat:@"%@%@/%@/%@/%@",BaseUrl,strtoken,localitylist,english,strCityId];
...
- (void)alertView:(UIAlertView *)alertView clickedButtonAtIndex:(NSInteger)buttonIndex
{
    ...
    else
    {
        ...
        NSString *strtoken=[[NSUserDefaults standardUserDefaults]objectForKey:@"Token"];
        NSString *strCityId=[[NSUserDefaults standardUserDefaults]objectForKey:@"CityId"];
        NSString *strurl=[NSString stringWithFormat:@"%@%@/%@/%@/%@",BaseUrl,strtoken,fileDelete,english,strCityId];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    else if (tableView.tag==4)
    {
        ...
        if ([strSubModule isEqualToString:[NSString stringWithFormat:@"%@",@"1"]])
        {
            ...
            NSString *strtoken=[[NSUserDefaults standardUserDefaults]objectForKey:@"Token"];
            NSString *strCityId=[[NSUserDefaults standardUserDefaults]objectForKey:@"CityId"];
            NSString *strurl=[NSString stringWithFormat:@"%@%@/%@/%@/%@?module=%@&submodule=%@&parent=%@",BaseUrl,strtoken,Categoty,english,strCityId,_strcategeoryTypeurl_parameter,@"category",strsubCategoryid];
        ...
        else
        {
            ...
            NSString *strtoken=[[NSUserDefaults standardUserDefaults]objectForKey:@"Token"];
            NSString *strCityId=[[NSUserDefaults standardUserDefaults]objectForKey:@"CityId"];
            NSString *strurl=[NSString stringWithFormat:@"%@%@/%@/%@/%@?module=%@&category=%@",BaseUrl,strtoken,CategoryOption,english,strCityId,_strcategeoryTypeurl_parameter,strsubCategoryid];
    ...
    else if (tableView.tag==5)
    {
        ...
        if ([strSubModule isEqualToString:[NSString stringWithFormat:@"%@",@"1"]])
        {
            ...
            NSString *strtoken=[[NSUserDefaults standardUserDefaults]objectForKey:@"Token"];
            NSString *strCityId=[[NSUserDefaults standardUserDefaults]objectForKey:@"CityId"];
            NSString *strurl=[NSString stringWithFormat:@"%@%@/%@/%@/%@?module=%@&submodule=%@&parent=%@",BaseUrl,strtoken,Categoty,english,strCityId,_strcategeoryTypeurl_parameter,@"category",strsubCategoryid2];
        ...
        else
        {
            ...
            NSString *strtoken=[[NSUserDefaults standardUserDefaults]objectForKey:@"Token"];
            NSString *strCityId=[[NSUserDefaults standardUserDefaults]objectForKey:@"CityId"];
            NSString *strurl=[NSString stringWithFormat:@"%@%@/%@/%@/%@?module=%@&category=%@",BaseUrl,strtoken,CategoryOption,english,strCityId,_strcategeoryTypeurl_parameter,strsubCategoryid2];
    ...
    else if (tableView.tag==6)
    {
        ...
        if ([strSubModule isEqualToString:[NSString stringWithFormat:@"%@",@"1"]])
        {
            ...
            NSString *strtoken=[[NSUserDefaults standardUserDefaults]objectForKey:@"Token"];
            NSString *strCityId=[[NSUserDefaults standardUserDefaults]objectForKey:@"CityId"];
            NSString *strurl=[NSString stringWithFormat:@"%@%@/%@/%@/%@?module=%@&submodule=%@&parent=%@",BaseUrl,strtoken,Categoty,english,strCityId,_strcategeoryTypeurl_parameter,@"category",strsubCategoryid3];
        ...
        else
        {
            ...
            NSString *strtoken=[[NSUserDefaults standardUserDefaults]objectForKey:@"Token"];
            NSString *strCityId=[[NSUserDefaults standardUserDefaults]objectForKey:@"CityId"];
            NSString *strurl=[NSString stringWithFormat:@"%@%@/%@/%@/%@?module=%@&category=%@",BaseUrl,strtoken,CategoryOption,english,strCityId,_strcategeoryTypeurl_parameter,strsubCategoryid3];
    ...
    else if (tableView.tag==7)
    {
        ...
        else
        {
            ...
            NSString *strtoken=[[NSUserDefaults standardUserDefaults]objectForKey:@"Token"];
            NSString *strCityId=[[NSUserDefaults standardUserDefaults]objectForKey:@"CityId"];
            NSString *strurl=[NSString stringWithFormat:@"%@%@/%@/%@/%@?module=%@&category=%@",BaseUrl,strtoken,CategoryOption,english,strCityId,_strcategeoryTypeurl_parameter,strsubCategoryid4];
