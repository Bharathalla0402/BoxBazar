...
@interface AccountInformationViewController ()<ApiRequestdelegate,UITextFieldDelegate,HMDiallingCodeDelegate>
{
...
//    [topview1 addSubview:MobileNumber];
    ...
    AdsPostLabel=[[UILabel alloc]initWithFrame:CGRectMake(view2.frame.size.width-60, 1, 50, 50)];
    AdsPostLabel.text=@"0";
    AdsPostLabel.textColor=[UIColor blackColor];
    AdsPostLabel.font = [UIFont systemFontOfSize:15];
    AdsPostLabel.textAlignment = NSTextAlignmentRight;
    ...
    MyShortlistLabel=[[UILabel alloc]initWithFrame:CGRectMake(view2.frame.size.width-60,label6.frame.origin.y+label6.frame.size.height+1, 50, 50)];
    MyShortlistLabel.text=@"0";
    MyShortlistLabel.textColor=[UIColor blackColor];
    MyShortlistLabel.font = [UIFont systemFontOfSize:15];
    MyShortlistLabel.textAlignment = NSTextAlignmentRight;
    ...
    UIButton *ChangePasswordbutt=[[UIButton alloc]initWithFrame:CGRectMake(6, label8.frame.origin.y+label8.frame.size.height+1, view2.frame.size.width-60, 50)];
    ...
    UIButton *forgotpasswordbutt=[[UIButton alloc]initWithFrame:CGRectMake(6, label18.frame.origin.y+label18.frame.size.height+1, view2.frame.size.width-60, 50)];
    ...
    UIButton *changeMobilebutt=[[UIButton alloc]initWithFrame:CGRectMake(6, label18.frame.origin.y+label18.frame.size.height+1, view2.frame.size.width-60, 50)];
    [changeMobilebutt setTitle:@"Change Mobile Number" forState:UIControlStateNormal];
    changeMobilebutt.contentHorizontalAlignment = UIControlContentHorizontalAlignmentLeft;
...
-(void)responsewithToken3:(NSMutableDictionary *)responseDict
{
    ...
    {
        AdsListViewController *lr=[self.storyboard instantiateViewControllerWithIdentifier:@"AdsListViewController"];
        lr.arrChildCategory=[responseDict valueForKey:@"data"];
        lr.strtitle=@"Ads Posted";
...
-(void)responsewithToken4:(NSMutableDictionary *)responseDict
{
    ...
    if ([strstatus isEqualToString:@"1"])
    {
        FavoritelistViewController *lr=[self.storyboard instantiateViewControllerWithIdentifier:@"FavoritelistViewController"];
        lr.arrChildCategory=[responseDict valueForKey:@"data"];
...
-(IBAction)DoneButtClicked1:(id)sender
{
    ...
    else
    {
     ...
     //   NSString *post = [NSString stringWithFormat:@"user_id=%@&otp=%@",struseridnumer,txtverifycode.text];
        NSString *strtoken=[[NSUserDefaults standardUserDefaults]objectForKey:@"Token"];
        NSString *strCityId=[[NSUserDefaults standardUserDefaults]objectForKey:@"CityId"];
        NSString *strurl=[NSString stringWithFormat:@"%@%@/%@/%@/%@?user_id=%@&otp=%@",BaseUrl,strtoken,verify_mobile_otp,english,strCityId,struseridnumer,txtverifycode.text];
...
-(void)responseRegistrationotp:(NSMutableDictionary *)responseToken
{
    ...
    if([strstatus isEqualToString:@"1"])
    {
      ...
      //  [self.navigationController popViewControllerAnimated:YES];
        ...
        NSString *strurl=[NSString stringWithFormat:@"%@%@/%@/%@/%@?user=%@",BaseUrl,strtoken,userProfile,english,strCityId,struseridnu];
...
-(IBAction)ResendButtClicked:(id)sender
{
    ...
    NSString *strtoken=[[NSUserDefaults standardUserDefaults]objectForKey:@"Token"];
    NSString *strCityId=[[NSUserDefaults standardUserDefaults]objectForKey:@"CityId"];
    NSString *strurl=[NSString stringWithFormat:@"%@%@/%@/%@/%@?user_id=%@",BaseUrl,strtoken,resend_mobile_otp,english,strCityId,struseridnumer];
...
-(IBAction)changeMobilebuttClicked:(id)sender
{
    ...
    pluslabel=[[ACFloatingTextField alloc]initWithFrame:CGRectMake(10, labeunder.frame.size.height+labeunder.frame.origin.y+15, 10, 40)];
    ...
    txtCountryCode=[[ACFloatingTextField alloc]initWithFrame:CGRectMake(20, labeunder.frame.size.height+labeunder.frame.origin.y+15,55, 40)];
    ...
    DobButt=[[UIButton alloc]initWithFrame:CGRectMake(20, labeunder.frame.size.height+labeunder.frame.origin.y+15,55, 40)];
    ...
    txtMobileNumber=[[ACFloatingTextField alloc]initWithFrame:CGRectMake(85, labeunder.frame.size.height+labeunder.frame.origin.y+15, footerview.frame.size.width-97, 40)];
...
-(IBAction)UpdateDoneButtClicked:(id)sender
{
    ...
    else
    {
        ...
        NSString *strurl=[NSString stringWithFormat:@"%@%@/%@/%@/%@",BaseUrl,strtoken,updateMobile,english,strCityId];
