...
#import "ChatArabicViewController.h"
#import "ApiRequest.h"
#import "ChatArabicTableViewCell.h"
...
@interface ChatArabicViewController ()<ApiRequestdelegate,UITableViewDelegate,UITableViewDataSource>
{
...
@implementation ChatArabicViewController
...
- (void)viewDidLoad {
    ...
    if(object != nil)
    {
        ...
        NSString *strurl=[NSString stringWithFormat:@"%@%@/%@/%@/%@?user_id=%@&type=%@",BaseUrl,strtoken,getConversionList,arabic,strCityId,struseridnum,@"0"];
...
- (void)MySegmentControlAction:(UISegmentedControl *)segment
{
    ...
    else if(segment.selectedSegmentIndex == 1)
    {
        ...
        if(object != nil)
        {
            ...
            NSString *strtoken=[[NSUserDefaults standardUserDefaults]objectForKey:@"Token"];
            NSString *strCityId=[[NSUserDefaults standardUserDefaults]objectForKey:@"CityId"];
            NSString *strurl=[NSString stringWithFormat:@"%@%@/%@/%@/%@?user_id=%@&type=%@",BaseUrl,strtoken,getConversionList,arabic,strCityId,struseridnum,@"1"];
    ...
    else if(segment.selectedSegmentIndex == 2)
    {
        ...
        if(object != nil)
        {
            ...
            NSString *strtoken=[[NSUserDefaults standardUserDefaults]objectForKey:@"Token"];
            NSString *strCityId=[[NSUserDefaults standardUserDefaults]objectForKey:@"CityId"];
            NSString *strurl=[NSString stringWithFormat:@"%@%@/%@/%@/%@?user_id=%@&type=%@",BaseUrl,strtoken,getConversionList,arabic,strCityId,struseridnum,@"2"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    if (tableView.tag==1)
    {
        static NSString *CellClassName = @"ChatArabicTableViewCell";
        
        cell = (ChatArabicTableViewCell *)[tableView dequeueReusableCellWithIdentifier: CellClassName];
        
        if (cell == nil)
        {
            cell = [[ChatArabicTableViewCell alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:CellClassName];
            NSArray *nib = [[NSBundle mainBundle] loadNibNamed:@"ChatArabicTableViewCell"
