//
//  JobslistArabicViewController.m
//  BoxBazar
//
...
@interface JobslistArabicViewController ()<ApiRequestdelegate,UITableViewDataSource,UITableViewDelegate,UISearchBarDelegate,UISearchDisplayDelegate,UISearchResultsUpdating>
{
...
@implementation JobslistArabicViewController
...
-(void)responseSubCategory4:(NSMutableDictionary *)responseDict
{
    ...
    if ([strstatus isEqualToString:@"1"])
    {
        ...
        NSString *result = [[arrayThatYouCanRemoveObjects valueForKey:@"id"] componentsJoinedByString:@","];
        
        
        
        NSDictionary *dict=[[NSDictionary alloc]initWithObjectsAndKeys:@"0",@"haschaild",result,@"id",@"All Jobs",@"name", nil];
        
        //     NSLog(@"%@",dict);
        
        _arrChildCategory=[[NSMutableArray alloc]initWithObjects:dict, nil];
        
        _arrChildCategory=[[_arrChildCategory arrayByAddingObjectsFromArray:arrayThatYouCanRemoveObjects] mutableCopy];
        
        
        //  _arrChildCategory = [NSMutableArray arrayWithArray: arrayThatYouCanRemoveObjects];
        ...
        theSearchBar.placeholder = @"Search Jobs";
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (tabl.tag==2)
    {
        ...
        if ([strname isEqualToString:@"All Jobs"])
        {
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    else
    {
        ...
        {
            if ([strModuleName isEqualToString:@"All Jobs"])
            {
                [DejalBezelActivityView activityViewForView:self.view withLabel:@"please wait..."];
