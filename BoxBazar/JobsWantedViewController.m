...
@interface JobsWantedViewController ()<ApiRequestdelegate,UITableViewDataSource,UITableViewDelegate,UISearchBarDelegate,UISearchDisplayDelegate,UISearchResultsUpdating>
{
...
@implementation JobsWantedViewController
...
//    NSDictionary *dict=[[NSDictionary alloc]initWithObjectsAndKeys:@"0",@"haschaild",@"0",@"id",@"All Jobs Wanted",@"name", nil];
//    
//    NSLog(@"%@",dict);
//    
