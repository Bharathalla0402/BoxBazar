...
@interface PostadsarabicViewController : UIViewController<UIImagePickerControllerDelegate,UINavigationControllerDelegate,kDropDownListViewDelegate>
{
    NSArray *arryList;
