...
@interface FindCarViewController ()<ApiRequestdelegate,UITableViewDelegate,UITableViewDataSource>
{
...
- (void)setUpViewComponents
{
    ...
    [self.rangeSlider setLeftValue:500 rightValue:250000];
...
-(void)customView
{
    ...
    lookingforspecificlab.text=@"Looking for a specific Model?";
    lookingforspecificlab.textColor=[UIColor blackColor];
    lookingforspecificlab.textAlignment=NSTextAlignmentLeft;
    ...
    image=[[UIImageView alloc] initWithFrame:CGRectMake(20, 20, 40, 40)];
    image.image=[UIImage imageNamed:_strimage];
    [carslistView addSubview:image];
    
    
    FindPerfectCarbutt=[[UIButton alloc]initWithFrame:CGRectMake(image.frame.size.width+image.frame.origin.x+10, 20, carslistView.frame.size.width-70, 40)];
    [FindPerfectCarbutt setTitle:@"E.g Audi A4.." forState:UIControlStateNormal];
    ...
    UIImageView *image3=[[UIImageView alloc]initWithFrame:CGRectMake(carslistView.frame.size.width-40,28, 24, 24)];
    ...
    whatyourbudgetlab.text=@"Whats your Budget?";
    whatyourbudgetlab.textColor=[UIColor blackColor];
    whatyourbudgetlab.textAlignment=NSTextAlignmentLeft;
    ...
    [Findbutt setTitle:@"Find" forState:UIControlStateNormal];
    ...
    NSString *strurl=[NSString stringWithFormat:@"%@%@/%@/%@/%@?module=%@",BaseUrl,strtoken,carSubModule,english,strCityId,_strCarSubModule];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    NSString *strtoken=[[NSUserDefaults standardUserDefaults]objectForKey:@"Token"];
    NSString *strCityId=[[NSUserDefaults standardUserDefaults]objectForKey:@"CityId"];
    NSString *strurl=[NSString stringWithFormat:@"%@%@/%@/%@/%@?make=%@",BaseUrl,strtoken,carModel,english,strCityId,strSubModuleId];
...
{
    CarNameViewController *carfind=[self.storyboard instantiateViewControllerWithIdentifier:@"CarNameViewController"];
