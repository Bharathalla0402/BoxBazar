//
//  ArabicloginRegisterViewController.h
//  BoxBazar
//
...
@interface ArabicloginRegisterViewController : UIViewController<UITextFieldDelegate,GIDSignInDelegate,CLLocationManagerDelegate>
{
