//
//  ArabicloginRegisterViewController.m
//  BoxBazar
//
...
#import "SocialArabicViewController.h"
...
@interface ArabicloginRegisterViewController ()<ApiRequestdelegate,HMDiallingCodeDelegate,GIDSignInUIDelegate,GIDSignInDelegate>
{
    ApiRequest *request;
...
@implementation ArabicloginRegisterViewController
...
-(void)customView
{
    ...
    UIButton *Backbutt=[[UIButton alloc] initWithFrame:CGRectMake(topview.frame.size.width-42, topview.frame.size.height/2-5, 32, 32)];
    ...
    NSArray *itemArray = [NSArray arrayWithObjects: @"التسجيل", @"تسجيل الدخول", nil];
...
-(void)Login
{
    ...
    logoimage.image=[UIImage imageNamed:@"profilepic.png"];
    ...
    [txtEmail setTextFieldPlaceholderText:@"البريد الإلكتروني معرف/جوال رقم"];
    ...
    NSAttributedString *str1 = [[NSAttributedString alloc] initWithString:@"كلمة المرور" attributes:@{ NSForegroundColorAttributeName : [UIColor blackColor] }];
    ...
    UIButton *forgotPasswordbutt=[[UIButton alloc]initWithFrame:CGRectMake(10, PasswordUnderlabel.frame.origin.y+PasswordUnderlabel.frame.size.height+10, 140, 40)];
    [forgotPasswordbutt setTitle:@"هل نسيت كلمة المرور؟" forState:UIControlStateNormal];
    forgotPasswordbutt.contentHorizontalAlignment = UIControlContentHorizontalAlignmentLeft;
    ...
    [loginbutt setTitle:@"تسجيل الدخول" forState:UIControlStateNormal];
    ...
    loginbutt.backgroundColor=[UIColor blackColor];
    ...
    UIView *google=[[UIView alloc]initWithFrame:CGRectMake(loginView.frame.size.width/2-85, Orlabel.frame.size.height+Orlabel.frame.origin.y+20, 50, 50)];
    ...
    UIButton *googlebutt=[[UIButton alloc]initWithFrame:CGRectMake(loginView.frame.size.width/2-85, Orlabel.frame.size.height+Orlabel.frame.origin.y+20, 50, 50)];
    ...
    UIButton *linkedinbutt=[[UIButton alloc]initWithFrame:CGRectMake(googlebutt.frame.origin.x+googlebutt.frame.size.width+10, Orlabel.frame.size.height+Orlabel.frame.origin.y+20, 50, 50)];
    ...
    linkedinbutt.backgroundColor=[UIColor colorWithRed:103.0/255.0f green:125.0/255.0f blue:180.0/255.0f alpha:1.0];
    ...
    UIButton *Facebookbutt=[[UIButton alloc]initWithFrame:CGRectMake(linkedinbutt.frame.origin.x+linkedinbutt.frame.size.width+10, Orlabel.frame.size.height+Orlabel.frame.origin.y+20, 50, 50)];
...
-(IBAction)forgotPasswordClicked:(id)sender
{
    ...
    NSAttributedString *str = [[NSAttributedString alloc] initWithString:@"أدخل رقم هاتفك المحمول المسجل" attributes:@{ NSForegroundColorAttributeName : [UIColor blackColor] }];
    ...
    [butt setTitle:@"إلغاء الأمر" forState:UIControlStateNormal];
    ...
    [butt1 setTitle:@"إرسال" forState:UIControlStateNormal];
...
-(IBAction)loginButtClicked:(id)sender
{
    ...
    else
    {
        ...
        NSString *strtoken=[[NSUserDefaults standardUserDefaults]objectForKey:@"Token"];
        NSString *strCityId=[[NSUserDefaults standardUserDefaults]objectForKey:@"CityId"];
        NSString *strurl=[NSString stringWithFormat:@"%@%@/%@/%@/%@",BaseUrl,strtoken,userlogin,arabic,strCityId];
...
-(void)Registration
{
    ...
    UIView *google=[[UIView alloc]initWithFrame:CGRectMake(6,15, RegistrationView.frame.size.width/3-8, 50)];
    google.backgroundColor=[UIColor lightGrayColor];
    google.layer.cornerRadius = 8; // this value vary as per your desire
    google.clipsToBounds = YES;
    ...
    UIButton *RegisterGooglebutt=[[UIButton alloc]initWithFrame:CGRectMake(6,15, RegistrationView.frame.size.width/3-8, 50)];
    ...
    UIButton *Registerlinkedinbutt=[[UIButton alloc]initWithFrame:CGRectMake(RegisterGooglebutt.frame.origin.x+RegisterGooglebutt.frame.size.width+6, 15, RegistrationView.frame.size.width/3-8, 50)];
    ...
    UIButton *RegisterFacebookbutt=[[UIButton alloc]initWithFrame:CGRectMake(Registerlinkedinbutt.frame.origin.x+Registerlinkedinbutt.frame.size.width+6, 15, RegistrationView.frame.size.width/3-8, 50)];
    ...
    txtRegEmail.textAlignment = NSTextAlignmentRight;
    ...
    txtRegPassword.textAlignment = NSTextAlignmentRight;
    ...
    txtConformRegPassword.textAlignment = NSTextAlignmentRight;
    ...
    pluslabel=[[ACFloatingTextField alloc]initWithFrame:CGRectMake(RegistrationView.frame.size.width-20, txtConformRegPassword.frame.size.height+txtConformRegPassword.frame.origin.y+15, 10, 40)];
    ...
    txtCountryCode=[[ACFloatingTextField alloc]initWithFrame:CGRectMake(RegistrationView.frame.size.width-75, txtConformRegPassword.frame.size.height+txtConformRegPassword.frame.origin.y+15,55, 40)];
    ...
    DobButt=[[UIButton alloc]initWithFrame:CGRectMake(RegistrationView.frame.size.width-75, txtConformRegPassword.frame.size.height+txtConformRegPassword.frame.origin.y+15,55, 40)];
    [DobButt addTarget:self action:@selector(DobbuttClicked2:) forControlEvents:UIControlEventTouchUpInside];
    DobButt.backgroundColor=[UIColor clearColor];
    [RegistrationView addSubview:DobButt];
    
    
    txtMobileNumber=[[ACFloatingTextField alloc]initWithFrame:CGRectMake(10, txtConformRegPassword.frame.size.height+txtConformRegPassword.frame.origin.y+15, RegistrationView.frame.size.width-97, 40)];
    ...
    UIButton *Termsbutt=[[UIButton alloc]initWithFrame:CGRectMake(termsView.frame.size.width/2-159, 0, 131, 30)];
    ...
    Termsbutt.titleLabel.textAlignment = NSTextAlignmentRight;
    ...
    UILabel *label1=[[UILabel alloc]initWithFrame:CGRectMake(Termsbutt.frame.size.width+Termsbutt.frame.origin.x,0, 180, 30)];
                ...
                [[[FBSDKGraphRequest alloc] initWithGraphPath:@"me" parameters:@{@"fields" : @"email,name,first_name,last_name,gender,birthday,picture.width(100).height(100)"}]
                 startWithCompletionHandler:^(FBSDKGraphRequestConnection *connection, id result, NSError *error) {
                     if (!error) {
                         ...
                         [DejalBezelActivityView removeView];
                         SocialArabicViewController *social=[self.storyboard instantiateViewControllerWithIdentifier:@"SocialArabicViewController"];
                         social.strUrl=url;
...
-(IBAction)RegistrationButtClicked:(id)sender
{
    ...
    else
    {
        ...
        NSString *strtoken=[[NSUserDefaults standardUserDefaults]objectForKey:@"Token"];
        NSString *strCityId=[[NSUserDefaults standardUserDefaults]objectForKey:@"CityId"];
        NSString *strurl=[NSString stringWithFormat:@"%@%@/%@/%@/%@",BaseUrl,strtoken,userRegister,arabic,strCityId];
...
-(IBAction)DoneButtClicked1:(id)sender
{
    ...
    else
    {
        ...
        NSString *strtoken=[[NSUserDefaults standardUserDefaults]objectForKey:@"Token"];
        NSString *strCityId=[[NSUserDefaults standardUserDefaults]objectForKey:@"CityId"];
        NSString *strurl=[NSString stringWithFormat:@"%@%@/%@/%@/%@?user_id=%@&otp=%@",BaseUrl,strtoken,verifyotp,arabic,strCityId,struseridnumer,txtverifycode.text];
...
-(IBAction)ResendButtClicked:(id)sender
{
    ...
    NSString *strtoken=[[NSUserDefaults standardUserDefaults]objectForKey:@"Token"];
    NSString *strCityId=[[NSUserDefaults standardUserDefaults]objectForKey:@"CityId"];
    NSString *strurl=[NSString stringWithFormat:@"%@%@/%@/%@/%@?user_id=%@",BaseUrl,strtoken,resendOtp,arabic,strCityId,struseridnumer];
