...
#import "ApiRequest.h"
#import "MotorCategeoryArabicTableViewCell.h"
#import "MotorCategeory2ArabicTableViewCell.h"
...
@interface CarnameArabicViewController ()<ApiRequestdelegate>
{
    ...
    MotorCategeoryArabicTableViewCell *cell;
    MotorCategeoryArabicTableViewCell *cell1;
    
    MotorCategeory2ArabicTableViewCell *cell2;
    MotorCategeory2ArabicTableViewCell *cell3;
...
@implementation CarnameArabicViewController
        ...
        if ([_strmodule isEqualToString:@"car"])
        {
            ...
            if (strmakeids == (id)[NSNull null] || strmakeids.length == 0 )
            {
                if (strmodelids == (id)[NSNull null] || strmodelids.length == 0 )
                {
                    ...
                    NSString *strurl=[NSString stringWithFormat:@"%@%@/%@/%@/%@",BaseUrl,strtoken,CarPosts,arabic,strCityId];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    else
    {
        if ([_strmodule isEqualToString:@"car"])
        {
            static NSString *CellClassName = @"MotorCategeory2ArabicTableViewCell";
            cell2 = (MotorCategeory2ArabicTableViewCell *)[tableView dequeueReusableCellWithIdentifier: CellClassName];
            if (cell2 == nil)
            {
                cell2 = [[MotorCategeory2ArabicTableViewCell alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:CellClassName];
                NSArray *nib = [[NSBundle mainBundle] loadNibNamed:@"MotorCategeory2ArabicTableViewCell"
        ...
        {
            static NSString *CellClassName = @"MotorCategeoryArabicTableViewCell";
            cell = (MotorCategeoryArabicTableViewCell *)[tableView dequeueReusableCellWithIdentifier: CellClassName];
            if (cell == nil)
            {
                cell = [[MotorCategeoryArabicTableViewCell alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:CellClassName];
                NSArray *nib = [[NSBundle mainBundle] loadNibNamed:@"MotorCategeoryArabicTableViewCell"
                                                             owner:self options:nil];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    else if (tableView.tag==2)
    {
        ...
        else if (indexPath.row==3)
        {
            ...
            NSString *strtoken=[[NSUserDefaults standardUserDefaults]objectForKey:@"Token"];
            NSString *strCityId=[[NSUserDefaults standardUserDefaults]objectForKey:@"CityId"];
            NSString *strurl=[NSString stringWithFormat:@"%@%@/%@/%@/%@?module=%@",BaseUrl,strtoken,carSubModule,arabic,strCityId,@"1"];
        ...
        else if (indexPath.row==4)
        {
            ...
            else
            {
                ...
                NSString *strtoken=[[NSUserDefaults standardUserDefaults]objectForKey:@"Token"];
                NSString *strCityId=[[NSUserDefaults standardUserDefaults]objectForKey:@"CityId"];
                NSString *strurl=[NSString stringWithFormat:@"%@%@/%@/%@/%@?make=%@",BaseUrl,strtoken,carModel,arabic,strCityId,strmakeids];
    ...
    else
    {
        if (_strCategeoryid == (id)[NSNull null] || _strCategeoryid.length == 0 )
        {
            ...
            else
            {
                ...
                NSString *strtoken=[[NSUserDefaults standardUserDefaults]objectForKey:@"Token"];
                NSString *strCityId=[[NSUserDefaults standardUserDefaults]objectForKey:@"CityId"];
                NSString *strurl=[NSString stringWithFormat:@"%@%@/%@/%@/%@?module=%@&category=%@",BaseUrl,strtoken,CategoryOption,arabic,strCityId,_strmodule,@"0"];
        ...
        else
        {
            ...
            NSString *strtoken=[[NSUserDefaults standardUserDefaults]objectForKey:@"Token"];
            NSString *strCityId=[[NSUserDefaults standardUserDefaults]objectForKey:@"CityId"];
            NSString *strurl=[NSString stringWithFormat:@"%@%@/%@/%@/%@?module=%@&category=%@",BaseUrl,strtoken,CategoryOption,arabic,strCityId,_strmodule,_strCategeoryid];
            [requested CategoryOptionRequest:nil withUrl:strurl];
        }
    }
}
...
-(void)responsewithDataMakeMotor:(NSMutableDictionary *)responseDict
{
    NSMutableDictionary *responseDictionary=[[NSMutableDictionary alloc]init];
    responseDictionary=responseDict;
    NSLog(@"Motor Model Response: %@",responseDictionary);
...
-(void)responseCategoryOption:(NSMutableDictionary *)responseDict
{
    ...
    if ([message isEqualToString:@"0"])
    {
        ...
        NSString *strtoken=[[NSUserDefaults standardUserDefaults]objectForKey:@"Token"];
        NSString *strCityId=[[NSUserDefaults standardUserDefaults]objectForKey:@"CityId"];
        NSString *strurl=[NSString stringWithFormat:@"%@%@/%@/%@/%@?module=%@",BaseUrl,strtoken,Option,arabic,strCityId,_strmodule];
    ...
    else
    {
        ...
        NSString *strtoken=[[NSUserDefaults standardUserDefaults]objectForKey:@"Token"];
        NSString *strCityId=[[NSUserDefaults standardUserDefaults]objectForKey:@"CityId"];
        NSString *strurl=[NSString stringWithFormat:@"%@%@/%@/%@/%@?module=%@&optionId=%@",BaseUrl,strtoken,Option,arabic,strCityId,_strmodule,strdata];
        [requested OptionRequest:nil withUrl:strurl];
    }
}
...
-(void)FilterClicked
{
    ...
    if ([_strmodule isEqualToString:@"car"])
    {
        ...
        tablf.frame = CGRectMake(self.view.frame.size.width-160,lab.frame.origin.y+lab.frame.size.height, 160, self.view.frame.size.height-110);
