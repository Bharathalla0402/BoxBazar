...
#import "JobCategeoryTableViewCell.h"
#import "BoxBazarUrl.pch"
#import "DejalActivityView.h"

@interface JobFilterViewController ()<UISearchBarDelegate,UITableViewDelegate,UITableViewDataSource,ApiRequestdelegate,UITextFieldDelegate>
{
    ...
    JobCategeoryTableViewCell *cell;
    JobCategeoryTableViewCell *cell1;
...
@implementation JobFilterViewController
...
-(void)responsewithData:(NSMutableDictionary *)responseDict
{
    ...
    [[NSUserDefaults standardUserDefaults]setObject:data forKey:@"localities"];
...
- (void)viewDidLoad {
   ...
   _topview.backgroundColor=[UIColor colorWithRed:229.0/255.0f green:26.0/255.0f blue:90.0/255.0f alpha:1.0];
    ...
    NSData *data = [defaults objectForKey:@"localities"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (tableView.tag==2)
    {
        cell5 = [tableView dequeueReusableCellWithIdentifier:CellIdentifier1];
        if (cell5 == nil) {
            cell5 = [[UITableViewCell alloc]
                     initWithStyle:UITableViewCellStyleDefault
                     reuseIdentifier:CellIdentifier1];
            cell5.backgroundColor=[UIColor lightTextColor];
    ...
    {
        cell5 = [tableView dequeueReusableCellWithIdentifier:CellIdentifier2];
        if (cell5 == nil) {
            cell5 = [[UITableViewCell alloc]
                     initWithStyle:UITableViewCellStyleDefault
        ...
        cell5.textLabel.text=[[arrlocalities valueForKey:@"name"] objectAtIndex:indexPath.row];
        cell5.textLabel.font=[UIFont systemFontOfSize:14];
        return cell5;
    ...
    else if (tableView.tag==4)
    {
        ...
        cell5.textLabel.text=[arrroles objectAtIndex:indexPath.row];
        cell5.textLabel.font=[UIFont systemFontOfSize:14];
        return cell5;
    ...
    else if (tableView.tag==5)
    {
        ...
        cell5.textLabel.text=[arreducation objectAtIndex:indexPath.row];
        cell5.textLabel.font=[UIFont systemFontOfSize:14];
    ...
    {
        static NSString *CellClassName = @"JobCategeoryTableViewCell";
        
        cell = (JobCategeoryTableViewCell *)[tableView dequeueReusableCellWithIdentifier: CellClassName];
        
        if (cell == nil)
        {
            cell = [[JobCategeoryTableViewCell alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:CellClassName];
            NSArray *nib = [[NSBundle mainBundle] loadNibNamed:@"JobCategeoryTableViewCell"
...
-(void)FilterClicked
{
    ...
    table=[[UITableView alloc] init];
    table.frame = CGRectMake(0,lab.frame.origin.y+lab.frame.size.height, 160, self.view.frame.size.height-110);
...
-(void)localityview
{
    searchEducation=[[UITextField alloc]initWithFrame:CGRectMake(5, 5, localitiesView.frame.size.width-26, 40)];
    ...
    searchEducation.contentHorizontalAlignment = UIControlContentHorizontalAlignmentLeft;
    ...
    UIButton *SearchEdubutt=[[UIButton alloc] initWithFrame:CGRectMake(localitiesView.frame.size.width-29, 13, 24, 24)];
...
-(void)roleView
{
    ...
    searchEducation=[[UITextField alloc]initWithFrame:CGRectMake(5, 5, RoleView.frame.size.width-26, 40)];
    ...
    UIButton *SearchEdubutt=[[UIButton alloc] initWithFrame:CGRectMake(RoleView.frame.size.width-29, 13, 24, 24)];
    [SearchEdubutt setImage:[UIImage imageNamed:@"magnifying-glass-icon.png"] forState:UIControlStateNormal];
    SearchEdubutt.contentHorizontalAlignment = UIControlContentVerticalAlignmentCenter;
    [SearchEdubutt setTitleColor:[UIColor blackColor] forState:UIControlStateNormal];
    SearchEdubutt.titleLabel.font = [UIFont systemFontOfSize:15];
...
-(void)educationview
{
    searchEducation=[[UITextField alloc]initWithFrame:CGRectMake(5, 5, EducationView.frame.size.width-26, 40)];
    NSAttributedString *str1 = [[NSAttributedString alloc] initWithString:@"Search Role" attributes:@{ NSForegroundColorAttributeName : [UIColor blackColor] }];
    searchEducation.attributedPlaceholder = str1;
    searchEducation.contentHorizontalAlignment = UIControlContentHorizontalAlignmentLeft;
    searchEducation.textColor=[UIColor blackColor];
    ...
    UIButton *SearchEdubutt=[[UIButton alloc] initWithFrame:CGRectMake(EducationView.frame.size.width-29, 13, 24, 24)];
    [SearchEdubutt setImage:[UIImage imageNamed:@"magnifying-glass-icon.png"] forState:UIControlStateNormal];
    SearchEdubutt.contentHorizontalAlignment = UIControlContentVerticalAlignmentCenter;
    [SearchEdubutt setTitleColor:[UIColor blackColor] forState:UIControlStateNormal];
    SearchEdubutt.titleLabel.font = [UIFont systemFontOfSize:15];
