...
@interface SettingArabicViewController ()<ApiRequestdelegate>
{
...
@implementation SettingArabicViewController
...
- (void)viewDidLoad {
    ...
    [backButton setImage:[UIImage imageNamed:@"rightar.png"]];
...
//    [backButton2 setImage:[UIImage imageNamed:@"menu-2.png"]];
    ...
    else
    {
        ...
        NSString *strtoken=[[NSUserDefaults standardUserDefaults]objectForKey:@"Token"];
        NSString *strCityId=[[NSUserDefaults standardUserDefaults]objectForKey:@"CityId"];
        NSString *strurl=[NSString stringWithFormat:@"%@%@/%@/%@/%@?user=%@",BaseUrl,strtoken,userProfile,arabic,strCityId,_struid];
        [requested CitysRequest:nil withUrl:strurl];
    }
...
-(void)parseJSONR:(NSData*)responseData
{
    ...
    strlocation=[responseJSON valueForKey:@"location"];
}
...
-(void)customView
{
    ...
    UIImageView *editnameimage=[[UIImageView alloc] initWithFrame:CGRectMake(6, 17, 16, 16)];
    ...
    MobileNumber.textAlignment = NSTextAlignmentRight;
    ...
    txtEmailId.textAlignment = NSTextAlignmentRight;
    ...
    UIButton *ChangePasswordbutt=[[UIButton alloc]initWithFrame:CGRectMake(6, txtEmailId.frame.origin.y+txtEmailId.frame.size.height+2, detailsView.frame.size.width-12, 40)];
    ...
    UIImageView *image5=[[UIImageView alloc]initWithFrame:CGRectMake(6,txtEmailId.frame.origin.y+txtEmailId.frame.size.height+17, 16, 16)];
