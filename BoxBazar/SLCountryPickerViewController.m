...
- (void)createSearchBar {
        if (self.tableView && !self.tableView.tableHeaderView) {
            ...
            UIButton *Backbutt=[[UIButton alloc] initWithFrame:CGRectMake(10, 5, 30, 30)];
            ...
            UISearchBar * theSearchBar = [[UISearchBar alloc] initWithFrame:CGRectMake(50,0,320,40)]; // frame has no effect.
...
-(IBAction)BackbuttClicked5:(id)sender
{
