//
//  MotorFindsArabicViewController.m
//  BoxBazar
//
...
@interface MotorFindsArabicViewController ()<ApiRequestdelegate,UISearchBarDelegate,UISearchDisplayDelegate,UISearchResultsUpdating>
{
...
@implementation MotorFindsArabicViewController
...
- (void)viewDidLoad {
    ...
    else
    {
        ...
        NSString *strurl=[NSString stringWithFormat:@"%@%@/%@/%@/%@?category=%@",BaseUrl,strtoken,module,arabic,strCityId,@"1"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (tableView.tag==2)
    {
        ...
        UILabel *namel = [[UILabel alloc] initWithFrame:CGRectMake(10, 10, self.view.frame.size.width-20, 40)];
        ...
        UIImageView *image4=[[UIImageView alloc]initWithFrame:CGRectMake(6,22, 16, 16)];
    ...
    if (tableView.tag==2)
    {
        ...
        else
        {
            ...
            else
            {
                ...
                NSString *strtoken=[[NSUserDefaults standardUserDefaults]objectForKey:@"Token"];
                NSString *strCityId=[[NSUserDefaults standardUserDefaults]objectForKey:@"CityId"];
                NSString *strurl=[NSString stringWithFormat:@"%@%@/%@/%@/%@?module=%@&submodule=%@&parent=%@",BaseUrl,strtoken,Categoty,arabic,strCityId,strModuleUrlParameter,@"category",@"0"];
