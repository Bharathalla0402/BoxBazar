//
//  SubCategeorylistViewController.m
//  BoxBazar
//
...
#import "SubCategeory2ViewController.h"

@interface SubCategeorylistViewController ()<ApiRequestdelegate,UITableViewDataSource,UITableViewDelegate,UISearchBarDelegate,UISearchDisplayDelegate,UISearchResultsUpdating>
{
...
@implementation SubCategeorylistViewController
...
-(void)responseRegistrationotp:(NSMutableDictionary *)responseDict
{
    ...
    if ([strstatus isEqualToString:@"1"])
    {
     //   NSLog(@"Jobs list Response: %@",responseDict);
        ...
        SubCategeory2ViewController *post=[self.storyboard instantiateViewControllerWithIdentifier:@"SubCategeory2ViewController"];
