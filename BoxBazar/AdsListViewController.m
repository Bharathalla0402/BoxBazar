...
#import "PostAdsTableViewCell.h"

@interface AdsListViewController ()<ApiRequestdelegate,UITableViewDelegate,UITableViewDataSource>
{
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
        ...
        static NSString *CellClassName = @"PostAdsTableViewCell";
        cell3 = (PostAdsTableViewCell *)[tableView dequeueReusableCellWithIdentifier: CellClassName];
        if (cell3 == nil)
        {
            cell3 = [[PostAdsTableViewCell alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:CellClassName];
            NSArray *nib = [[NSBundle mainBundle] loadNibNamed:@"PostAdsTableViewCell"
...
//        [requested sendRequest3:post withUrl:strurl];
        ...
        NSString *strtoken=[[NSUserDefaults standardUserDefaults]objectForKey:@"Token"];
        NSString *strCityId=[[NSUserDefaults standardUserDefaults]objectForKey:@"CityId"];
        NSString *strurl=[NSString stringWithFormat:@"%@%@/%@/%@/%@?post_id=%@&module=%@",BaseUrl,strtoken,deletePost,english,strCityId,postid,strname];
