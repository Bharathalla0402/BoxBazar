...
@interface SocialArabicViewController ()<ApiRequestdelegate,UITextFieldDelegate,HMDiallingCodeDelegate>
{
    ApiRequest *request;
...
@implementation SocialArabicViewController
...
-(void)customView
{
    ...
    pluslabel=[[ACFloatingTextField alloc]initWithFrame:CGRectMake(loginView.frame.size.width-20, txtEmail.frame.size.height+txtEmail.frame.origin.y+15, 10, 40)];
    ...
    txtCountryCode=[[ACFloatingTextField alloc]initWithFrame:CGRectMake(loginView.frame.size.width-75, txtEmail.frame.size.height+txtEmail.frame.origin.y+15,55, 40)];
    ...
    GenderButt=[[UIButton alloc]initWithFrame:CGRectMake(loginView.frame.size.width-75, txtEmail.frame.size.height+txtEmail.frame.origin.y+15,55, 40)];
    [GenderButt addTarget:self action:@selector(DobbuttClicked3:) forControlEvents:UIControlEventTouchUpInside];
    GenderButt.backgroundColor=[UIColor clearColor];
    [loginView addSubview:GenderButt];
    
    txtMobileNumber=[[ACFloatingTextField alloc]initWithFrame:CGRectMake(10, txtEmail.frame.size.height+txtEmail.frame.origin.y+15, loginView.frame.size.width-97, 40)];
