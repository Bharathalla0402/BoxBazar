//
//  SubCategeorylistArabicViewController.m
//  BoxBazar
//
...
@interface SubCategeorylistArabicViewController ()<ApiRequestdelegate,UITableViewDataSource,UITableViewDelegate,UISearchBarDelegate,UISearchDisplayDelegate,UISearchResultsUpdating>
{
...
@implementation SubCategeorylistArabicViewController
...
-(void)responseRegistrationotp:(NSMutableDictionary *)responseDict
{
    ...
    if ([strstatus isEqualToString:@"1"])
    {
        ...
        SubCategeory2ArabicViewController *post=[self.storyboard instantiateViewControllerWithIdentifier:@"SubCategeory2ArabicViewController"];
