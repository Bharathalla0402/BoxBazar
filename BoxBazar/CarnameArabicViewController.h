...
@interface CarnameArabicViewController : UIViewController<UITableViewDataSource,UITableViewDelegate,UIImagePickerControllerDelegate,UINavigationControllerDelegate,kDropDownListViewDelegate,UISearchBarDelegate,CLLocationManagerDelegate>
{
