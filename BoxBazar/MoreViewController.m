...
@interface MoreViewController ()<ApiRequestdelegate>
{
    ApiRequest *request;
    BOOL isClick;
...
-(void)moreaction
{
    ...
    labellanguage=[[UILabel alloc]initWithFrame:CGRectMake(view1.frame.size.width-75, 0, 50, 30)];
    ...
    UIImageView *image1=[[UIImageView alloc]initWithFrame:CGRectMake(view1.frame.size.width-22, 8, 16, 16)];
    ...
    [languagebutt setTitle:@"Preffered Language" forState:UIControlStateNormal];
    languagebutt.contentHorizontalAlignment = UIControlContentHorizontalAlignmentLeft;
    ...
    UIButton *addsnearbybutt=[[UIButton alloc]initWithFrame:CGRectMake(6, label1.frame.origin.y+label1.frame.size.height+1, view1.frame.size.width-30, 30)];
    [addsnearbybutt setTitle:@"Ads Nearby" forState:UIControlStateNormal];
    addsnearbybutt.contentHorizontalAlignment = UIControlContentHorizontalAlignmentLeft;
    ...
    UIImageView *image2=[[UIImageView alloc]initWithFrame:CGRectMake(view1.frame.size.width-22,label1.frame.origin.y+label1.frame.size.height+9, 16, 16)];
    ...
    UIButton *RecentlyViewAdsbutt=[[UIButton alloc]initWithFrame:CGRectMake(6, label2.frame.origin.y+label2.frame.size.height+1, view1.frame.size.width-30, 30)];
    [RecentlyViewAdsbutt setTitle:@"Recently View Ads" forState:UIControlStateNormal];
    RecentlyViewAdsbutt.contentHorizontalAlignment = UIControlContentHorizontalAlignmentLeft;
    ...
    UIImageView *image3=[[UIImageView alloc]initWithFrame:CGRectMake(view1.frame.size.width-22,label2.frame.origin.y+label2.frame.size.height+9, 16, 16)];
    ...
    UIButton *PopularInYourAreabutt=[[UIButton alloc]initWithFrame:CGRectMake(6, label3.frame.origin.y+label3.frame.size.height+1, view1.frame.size.width-30, 30)];
    [PopularInYourAreabutt setTitle:@"Popular in your Area" forState:UIControlStateNormal];
    PopularInYourAreabutt.contentHorizontalAlignment = UIControlContentHorizontalAlignmentLeft;
    ...
    UIImageView *image4=[[UIImageView alloc]initWithFrame:CGRectMake(view1.frame.size.width-22,label3.frame.origin.y+label3.frame.size.height+9, 16, 16)];
    ...
    UIButton *ClearsearchHistorybutt=[[UIButton alloc]initWithFrame:CGRectMake(6, label4.frame.origin.y+label4.frame.size.height+1, view1.frame.size.width-30, 30)];
    [ClearsearchHistorybutt setTitle:@"Clear Search History" forState:UIControlStateNormal];
    ClearsearchHistorybutt.contentHorizontalAlignment = UIControlContentHorizontalAlignmentLeft;
    ...
    UIImageView *image5=[[UIImageView alloc]initWithFrame:CGRectMake(view1.frame.size.width-22,label4.frame.origin.y+label4.frame.size.height+9, 16, 16)];
    ...
    UIButton *Notificationsbutt=[[UIButton alloc]initWithFrame:CGRectMake(6, label5.frame.origin.y+label5.frame.size.height+2, view1.frame.size.width-70, 30)];
    [Notificationsbutt setTitle:@"Notification" forState:UIControlStateNormal];
    Notificationsbutt.contentHorizontalAlignment = UIControlContentHorizontalAlignmentLeft;
    ...
    UISwitch *switchcheck=[[UISwitch alloc]initWithFrame:CGRectMake(view1.frame.size.width-60,label5.frame.origin.y+label5.frame.size.height+2, 30, 30)];
    ...
    UIButton *settingsbutt=[[UIButton alloc]initWithFrame:CGRectMake(6, 1, view2.frame.size.width-30, 30)];
    [settingsbutt setTitle:@"Settings" forState:UIControlStateNormal];
    settingsbutt.contentHorizontalAlignment = UIControlContentHorizontalAlignmentLeft;
    ...
    UIImageView *image6=[[UIImageView alloc]initWithFrame:CGRectMake(view2.frame.size.width-22, 8, 16, 16)];
    ...
    UIButton *feedbackbutt=[[UIButton alloc]initWithFrame:CGRectMake(6, label6.frame.origin.y+label6.frame.size.height+1, view2.frame.size.width-30, 30)];
    [feedbackbutt setTitle:@"Feedback" forState:UIControlStateNormal];
    feedbackbutt.contentHorizontalAlignment = UIControlContentHorizontalAlignmentLeft;
    ...
    UIImageView *image7=[[UIImageView alloc]initWithFrame:CGRectMake(view2.frame.size.width-22,label6.frame.origin.y+label6.frame.size.height+9, 16, 16)];
    ...
    UIButton *ContactUsbutt=[[UIButton alloc]initWithFrame:CGRectMake(6, label7.frame.origin.y+label7.frame.size.height+1, view2.frame.size.width-30, 30)];
    [ContactUsbutt setTitle:@"Contact Us" forState:UIControlStateNormal];
    ContactUsbutt.contentHorizontalAlignment = UIControlContentHorizontalAlignmentLeft;
    ...
    UIImageView *image8=[[UIImageView alloc]initWithFrame:CGRectMake(view2.frame.size.width-22,label7.frame.origin.y+label7.frame.size.height+9, 16, 16)];
    image8.image=[UIImage imageNamed:@"right-arrow-2.png"];
    ...
    UIButton *RateUsbutt=[[UIButton alloc]initWithFrame:CGRectMake(6, label8.frame.origin.y+label8.frame.size.height+1, view2.frame.size.width-30, 30)];
    [RateUsbutt setTitle:@"Rate Us" forState:UIControlStateNormal];
    RateUsbutt.contentHorizontalAlignment = UIControlContentHorizontalAlignmentLeft;
    ...
    UIImageView *image9=[[UIImageView alloc]initWithFrame:CGRectMake(view2.frame.size.width-22,label8.frame.origin.y+label8.frame.size.height+9, 16, 16)];
    ...
    UIButton *Sharebutt=[[UIButton alloc]initWithFrame:CGRectMake(6, label9.frame.origin.y+label9.frame.size.height+1, view2.frame.size.width-30, 30)];
    [Sharebutt setTitle:@"Share" forState:UIControlStateNormal];
    Sharebutt.contentHorizontalAlignment = UIControlContentHorizontalAlignmentLeft;
    ...
    UIImageView *image10=[[UIImageView alloc]initWithFrame:CGRectMake(view2.frame.size.width-22,label9.frame.origin.y+label9.frame.size.height+9, 16, 16)];
...
-(IBAction)Arabicbutnclicked:(id)sender
{
  ...
  //  [request showMessage:@"Arabic Language Currently in the Developement.Check with English Language" withTitle:@""];
