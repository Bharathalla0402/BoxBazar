...
@interface ViewController ()<ApiRequestdelegate,LCBannerViewDelegate,UITableViewDataSource,UITableViewDelegate>
{
...
- (void)viewDidLoad
{
    ...
    [ceo reverseGeocodeLocation:loc completionHandler:^(NSArray *placemarks, NSError *error)
     {
         ...
         currentLocPlacemark = [placemarks objectAtIndex:0];
    ...
    NSObject * objects = [prefss objectForKey:@"Cit"];
    if(objects != nil)
    {
        NSUserDefaults *defaults = [NSUserDefaults standardUserDefaults];
        NSData *datalist = [defaults objectForKey:@"Cit"];
...
-(void)responsewithToken:(NSMutableDictionary *)responseToken
{
    ...
    if ([strstatus isEqualToString:@"1"])
    {
        ...
        if ([[[NSUserDefaults standardUserDefaults]objectForKey:@"language"] isEqualToString:@"English"])
        {
            ...
            NSString *strurl=[NSString stringWithFormat:@"%@%@/%@/%@/%@",BaseUrl,strtoken,gethomecategeory,english,strCityId];
...
-(void)responsewithDataMakeMotor:(NSMutableDictionary *)responseDict
{
    ...
    if ([strstatus isEqualToString:@"1"])
    {
        if ([[[NSUserDefaults standardUserDefaults]objectForKey:@"language"] isEqualToString:@"English"])
        {
            ...
            NSString *strurl1=[NSString stringWithFormat:@"%@%@/%@/%@/%@",BaseUrl,strtoken,homeSlider,english,strCityId];
...
-(void)responsewithCitylist:(NSMutableDictionary *)responseDict
{
    ...
    if ([strstatus isEqualToString:@"1"])
    {
        ...
        [[NSUserDefaults standardUserDefaults]setObject:datal forKey:@"Cit"];
        [[NSUserDefaults standardUserDefaults]synchronize];
...
-(void)homeview
{
    ...
    [[NSUserDefaults standardUserDefaults]setObject:@"b1" forKey:@"banar"];
    [[NSUserDefaults standardUserDefaults]synchronize];
...
//                      @"http://think360.co/boxbazaar/upload/slider/dummy.jpg"];
    ...
    image1.image=[UIImage imageNamed:@"motor-120x120.png"];
    ...
    [butt1 addTarget:self action:@selector(MotorButtClicked:) forControlEvents:UIControlEventTouchUpInside];
    ...
    image3.image=[UIImage imageNamed:@"jobs-120x120.png"];
    ...
    [butt3 addTarget:self action:@selector(JobsClicked:) forControlEvents:UIControlEventTouchUpInside];
    ...
    image4.image=[UIImage imageNamed:@"propertyonrent-120x120.png"];
    ...
    [butt4 addTarget:self action:@selector(PropertyonRentClicked:) forControlEvents:UIControlEventTouchUpInside];
    ...
    image6.image=[UIImage imageNamed:@"xxxhdpi.png"];
    ...
    [butt6 addTarget:self action:@selector(FurnitureClicked:) forControlEvents:UIControlEventTouchUpInside];
    [headerview addSubview:butt6];
    
    
    
    view7=[[UIView alloc]initWithFrame:CGRectMake(0,view4.frame.size.height+view4.frame.origin.y-2, self.view.frame.size.width/3, headerview.frame.size.height/2+1)];
    ...
    [butt7 addTarget:self action:@selector(ElectronicsClicked:) forControlEvents:UIControlEventTouchUpInside];
    ...
    [butt9 addTarget:self action:@selector(ServicesClicked:) forControlEvents:UIControlEventTouchUpInside];
    ...
    [butt10 addTarget:self action:@selector(bookSportsClicked:) forControlEvents:UIControlEventTouchUpInside];
    ...
    [butt12 addTarget:self action:@selector(LessClicked:) forControlEvents:UIControlEventTouchUpInside];
...
//    [Electronicappliancesbutt removeFromSuperview];
    ...
    for(int x = 0; x<homelistarray.count; x++)
    {
        if (x==0)
        {
            ...
            carslabel=[[UILabel alloc] initWithFrame:CGRectMake(5, 0, categeory1.frame.size.width-80, 30)];
            ...
            imagecar=[[UIImageView alloc]initWithFrame:CGRectMake(categeory1.frame.size.width-22,7, 16, 16)];
            imagecar.image=[UIImage imageNamed:@"right-arrow-2.png"];
            [categeory1 addSubview:imagecar];
            
            SeeAlllabel=[[UILabel alloc] initWithFrame:CGRectMake(categeory1.frame.size.width-80, 0, 55, 30)];
            ...
            CarsSellAllbutt=[[UIButton alloc]initWithFrame:CGRectMake(categeory1.frame.size.width-80, 0, 80, 30)];
        ...
        else if (x==1)
        {
            ...
            propertyforSalelab=[[UILabel alloc] initWithFrame:CGRectMake(5, 0, category2.frame.size.width-80, 30)];
            ...
            imageProperty=[[UIImageView alloc]initWithFrame:CGRectMake(category2.frame.size.width-22,7, 16, 16)];
            imageProperty.image=[UIImage imageNamed:@"right-arrow-2.png"];
            [category2 addSubview:imageProperty];
            
            seeallpropertylab=[[UILabel alloc] initWithFrame:CGRectMake(category2.frame.size.width-80, 0, 55, 30)];
            ...
            Propertyforsalebutt=[[UIButton alloc]initWithFrame:CGRectMake(category2.frame.size.width-80, 0, 80, 30)];
        ...
        else if (x==2)
        {
            ...
            ElectronicsApplianceslab=[[UILabel alloc] initWithFrame:CGRectMake(5, 0,categeory3.frame.size.width-80, 30)];
            ...
            imageElectronic=[[UIImageView alloc]initWithFrame:CGRectMake(categeory3.frame.size.width-22,7, 16, 16)];
            imageElectronic.image=[UIImage imageNamed:@"right-arrow-2.png"];
            [categeory3 addSubview:imageElectronic];
            
            seeAllElectroniclab=[[UILabel alloc] initWithFrame:CGRectMake(categeory3.frame.size.width-80, 0, 55, 30)];
            ...
            Electronicappliancesbutt=[[UIButton alloc]initWithFrame:CGRectMake(categeory3.frame.size.width-80, 0, 80, 30)];
...
//    [requested motorsEngRequest:nil withUrl:strurl];
    ...
    else
    {
        ...
        MotorlistViewController *mfb=[self.storyboard instantiateViewControllerWithIdentifier:@"MotorlistViewController"];
...
-(void)CategeoryRequest:(NSString*)categeoryId
{
    ...
    NSString *strtoken=[[NSUserDefaults standardUserDefaults]objectForKey:@"Token"];
    NSString *strCityId=[[NSUserDefaults standardUserDefaults]objectForKey:@"CityId"];
    NSString *strurl=[NSString stringWithFormat:@"%@%@/%@/%@/%@?category=%@",BaseUrl,strtoken,module,english,strCityId,categeoryId];
    [requested motorsRequest:nil withUrl:strurl];
}
...
//        [self.navigationController pushViewController:jobs animated:YES];
    ...
    else
    {
        ...
        NSString *strtoken=[[NSUserDefaults standardUserDefaults]objectForKey:@"Token"];
        NSString *strCityId=[[NSUserDefaults standardUserDefaults]objectForKey:@"CityId"];
        NSString *strurl=[NSString stringWithFormat:@"%@%@/%@/%@/%@?module=%@&submodule=%@&parent=%@",BaseUrl,strtoken,Categoty,english,strCityId,strmodule,@"category",@"0"];
...
-(void)viewWillAppear:(BOOL)animated
{
    ...
    if(object != nil)
    {
        ...
        if(object != nil)
        {
            ...
            NSString *strCityId=[[NSUserDefaults standardUserDefaults]objectForKey:@"CityId"];
            NSString *strurl=[NSString stringWithFormat:@"%@%@/%@/%@/%@",BaseUrl,@"123456",user,english,strCityId];
...
-(void)SetCountry
{
    ...
    txtCountryName.userInteractionEnabled=NO;
    ...
    [butt3 addTarget:self action:@selector(Cancelbclickedvb:) forControlEvents:UIControlEventTouchUpInside];
...
-(IBAction)Cancelbclickedvb:(id)sender
{
    [footerview removeFromSuperview];
    popview.hidden = YES;
...
{
    popview2 = [[ UIView alloc]init];
    popview2.frame = CGRectMake(0, 0, footerview.frame.size.width, footerview.frame.size.height);
    popview2.backgroundColor =  [UIColor colorWithPatternImage:[UIImage imageNamed:@"black_strip1.png"]];
    [footerview addSubview:popview2];
    ...
    [butt11 setTitleColor:[UIColor blackColor] forState:UIControlStateNormal];
    [butt11 addTarget:self action:@selector(Cancelclickedforb:) forControlEvents:UIControlEventTouchUpInside];
...
-(IBAction)Cancelclickedforb:(id)sender
{
...
-(IBAction)Setclicked:(id)sender
{
    ...
    if (txtSelectCity.text.length==0)
    {
        [requested showMessage:@"Please Select the Available Prefered City" withTitle:@""];
    }
    else if (txtLanguage.text.length==0)
    {
        [requested showMessage:@"Please Select the Prefered Language" withTitle:@""];
    }
    else
    {
...
//                  
//            //    NSString *strcountrycode=[NSString stringWithFormat:@"%@",placemark.ISOcountryCode];
//                  
////                  [[NSUserDefaults standardUserDefaults]setObject:strcountrycode forKey:@"countryCode"];
////                  [[NSUserDefaults standardUserDefaults]synchronize];
//                  
