...
-(void)addTextView
{
    ...
    _textView.placeholder = @"Type Your Message Here";
...
-(void)addRightButton
{
    ...
    UIImage *buttonImage = [UIImage imageNamed:@"send-button-2.png"];
...
-(void)didPressRightButton:(UIButton *)sender
{
    ...
    [self.delegate inputbarDidPressLeftButt:_textView.text];
