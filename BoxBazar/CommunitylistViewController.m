...
@interface CommunitylistViewController ()<ApiRequestdelegate,UITableViewDataSource,UITableViewDelegate,UISearchBarDelegate,UISearchDisplayDelegate,UISearchResultsUpdating>
{
...
-(void)customtoggleview
{
    ...
    else
    {
       // [self.navigationController.view showActivityViewWithLabel:@"Please Wait..."];
        ...
        //  [requested OptionRequest9:nil withUrl:strurl];
            ...
            dispatch_async (dispatch_get_main_queue(), ^{
                ...
                } else
                {
                    if(data1 != nil) {
                        ...
                        [self responseOption9:responseJSON];
    ...
    if ([strstatus isEqualToString:@"1"])
    {
        ...
        else
        {
         ...
         //   NSLog(@"Dict Response: %@",responseDictionary);
            ...
            // [requested SubCategoryRequest9:nil withUrl:strurl];
                ...
                dispatch_async (dispatch_get_main_queue(), ^{
                    ...
                    } else
                    {
                        if(data1 != nil) {
                            NSError *err;
                            NSMutableDictionary *responseJSON = [NSJSONSerialization JSONObjectWithData:data1 options:kNilOptions error:&err];
                            [self responseSubCategory9:responseJSON];
                            [DejalBezelActivityView removeView];
                        }
                    }
                });
